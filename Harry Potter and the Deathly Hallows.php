...
<?php
	...
	$sql = "SELECT * FROM product_info WHERE title='Harry Potter and the Deathly Hallows'";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			$dbname = "saikris1_onlineMarketPlace";
			$conn = new mysqli($servername, $username, $password, $dbname);	
			$sql="SELECT * FROM `product_info` WHERE owner='Venkat'";
			if ($conn->connect_error) {
    				die("Connection failed: " . $conn->connect_error);
			}
			$result = $conn->query($sql);
		   ...
		   ?>
			...
			$conn->close(); 
             ...
             <div class="container" id="Likesection">
               <span class="glyphicon glyphicon-thumbs-up" id="Like" onClick=onLike()></span>    
                   </div>
                   </td>
                   </tr></table>
